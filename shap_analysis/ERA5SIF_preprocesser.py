"""
Script: This script prepares and merge all the inpyt data required to perform the SHAP analysis for SIF. 
...
for months_wanted in month_groups:
    for year in years:
        outputdir = f'{FILELOCATION}PreprocessedData/ERAFLUXSAT/{months_wanted}/'
        ...
        try:
            ...
            # ERA_data = ERA_data.sel(latitude = slice(60, 91))
            ...
            # VPD_data = VPD_data.sel(latitude = slice(60,91))
            ...
            SIFGPP_data = xr.open_dataset(os.path.join(FILELOCATION, f'SIFGPPFluxSatNC_8day/SIFGPP_{year}.nc4'), chunks = 'auto')
        ...
        SIFGPP_data = SIFGPP_data.coarsen(latitude=2, longitude=2 , coord_func = 'min').mean()
        ...
        # print(SIFGPP_data)
        # SIFGPP_data needs to be aggregated into the same 0.1 deg resolution as others. I find pandas aggregations faster -> will be using that:
